...
python -m args_to_json \
    ...
    --swept_args "weight_loss_strategy|numb_layers_mclass_pred|mclass_pred_dropout_prob|mclass_pred_batchnorm|mclass_pred_hidden_size|freeze_mclass_head_from|freeze_mclass_head_until"
